...
class CreateCategoryNodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ('title', 'description', 'is_public', 'slug', 'parent', 'id',)
...
class CategoryTreeSerializer(serializers.ModelSerializer):
    ...
    def get_children(self, obj):
        return CreateCategoryNodeSerializer(obj.get_children(), many=True).data
...
class CategoryModificationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Category
        fields = ('title', 'description', 'is_public', 'id',)
